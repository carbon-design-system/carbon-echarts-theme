...
export function LegendsPage() {
  return (
    <div>
      ...
      <div className="content-page">
        ...
        <h2>Placement</h2>
        <p>
          Position legends consistently across all charts in a dashboard. Carbon recommends legends
          at the <strong>bottom</strong> of the chart for horizontal space efficiency. Right-side
          legends are acceptable for charts with few series.
        </p>
        <pre>
          <code>{`legend: {
  ...
  orient: 'vertical',
        ...
        <pre>
          <code>{`legend: { show: false }
// or omit legend entirely`}</code>
        </pre>
