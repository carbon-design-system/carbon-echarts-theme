  ...
  return (
    <div>
      ...
      <div className="content-page">
        <p>
          Dashboard layout guidance is framework-agnostic — it applies to any combination of
          charts, including ECharts with the Carbon theme.
        </p>
...
@media (max-width: 768px) {
  .dashboard {
    grid-template-columns: 1fr;
        ...
        <ul>
          <li><strong>Small</strong> — 200px (sparklines, gauges)</li>
          <li><strong>Medium</strong> — 320px (bar, line, donut)</li>
          <li><strong>Large</strong> — 480px (heatmap, treemap, sankey)</li>
        </ul>
        ...
        <pre><code>{`// Vanilla JS — observe container resize
const observer = new ResizeObserver(() => chart.resize())
observer.observe(container)

// React — echarts-for-react handles this automatically`}</code></pre>
      </div>
    </div>
  )
}
